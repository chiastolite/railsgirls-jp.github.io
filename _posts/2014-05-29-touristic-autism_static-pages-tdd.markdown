...
The basic guides that have been merged and adapted are the [Ruby on Rails Tutorial](https://www.railstutorial.org/book), the [basic RailsGirls app](https://guides.railsgirls.com/app/) and the tutorials for [creating thumbnails](https://guides.railsgirls.com/thumbnails), [authenticating users](https://guides.railsgirls.com/devise/), [adding design](https://guides.railsgirls.com/design), [deploying to OpenShift](https://guides.railsgirls.com/openshift/), [adding comments](https://guides.railsgirls.com/commenting) and [Mark McDonnell's tutorial](https://code.tutsplus.com/tutorials/testing-your-ruby-code-with-guard-rspec-pry--cms-19974).
