...
*Created by Floor Drees, [@floordrees](https://twitter.com/floordrees) for [Rails Girls Leiden](https://railsgirls.com/leiden)* 

### Get Trucker

Follow steps 1 through 3 of the [Getting Started guide](https://developers.trucker.io/Getting-Started) to create an account, install the command line tool and login.
...
Push successful! App 'railsgirls' available at https://railsgirls.ie.trucker.io
{% endhighlight %}

Your application is now available at https://railsgirls.ie.trucker.io!