...
*Created by Piotr Szotkowski ([chastell](https://chastell.net)) and Tomasz Stachewicz ([tomash](https://tomash.wrug.eu/about.html))*
...
__COACH__: For the rationale behind this slightly different beginners tutorial, take a look at this [post](https://dotclass.org/rails-girls-warsaw-programme/).
...
* [Visual Studio Code](https://code.visualstudio.com/), [Sublime Text](https://www.sublimetext.com),  Vim and Emacs are examples of text editors your can use for writing code and editing files.
