...
#### 3-2. [Homebrew](https://brew.sh/)をインストール:
...
Mac OS X 10.7〜10.9までは  [Sublime Text 3](https://www.sublimetext.com/3)  が、 
Mac OS X 10.6では  [Sublime Text 2](https://www.sublimetext.com/2) が、利用可能です。
...
Windows Vista およびそれ以前のバージョンでは Visual Studio Code は非対応ですが、[Sublime Text](https://www.sublimetext.com/2) を利用可能です。 
...
[RVM documentation](https://rvm.io/integration/gnome-terminal) を参照してください。
...
* [Sublime Text エディタをダウンロードしてインストールする](https://www.sublimetext.com/2)
...
URL例：　`https://node12.codenvy.io:50322/books`
...
* ガイドやチュートリアルが、`http://localhost:3000` にブラウザでアクセスするように指示している場合は、「Workspace の設定」で記録した `https://node1.codenvy.io:12345` のようなアドレス を使ってアクセスして下さい。例えば、チュートリアルが `http://localhost:3000/posts` にアクセスするように指示している場合は、`https://node1.codenvy.io:12345/posts` にアクセスして下さい。
